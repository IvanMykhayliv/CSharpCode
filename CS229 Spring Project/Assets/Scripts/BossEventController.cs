...
public class BossEventController : MonoBehaviour
{
    ...
    void incrementAggroEnemies()
    {
        EnemyControllerScript enemyScript = theEnemy.GetComponent<EnemyControllerScript>();
        enemyScript.walkingMultiplier += 4;
    }
